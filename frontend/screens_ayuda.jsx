    ...
    parcelas: {
        ...
        steps: [
            ...
            },
            {
                ...
                desc: 'Si tu parcela del SIGPAC está dividida en varios trozos (recintos), al buscarla te ofrecemos "➕ Crear todas": se crea una parcela por cada trozo de una sola vez. Antes de confirmar puedes desmarcar los trozos que no quieras dar de alta — los que SIGPAC clasifica como camino, agua, zona urbana u otro terreno no cultivable aparecen ya desmarcados con el aviso "⚠ (no agrícola)". Y si varios trozos tienen el mismo cultivo, te proponemos juntarlos en un grupo para apuntar las faenas una sola vez. Tú decides si agrupar o no.',
            },
            {
                icon: '🌱',
