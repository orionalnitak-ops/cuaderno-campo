...
function App() {
    ...
    if (activeForm) {
        return (
            <div style={{ minHeight: '100vh', background: '#f8f9fb', overflowY: 'auto' }}>
                <ScreenForms
        ...
        <div style={{ display: 'flex', minHeight: '100vh', background: '#f8f9fb' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0, ...((isImpersonating || planExpired || pagoFallido) ? { marginTop: 38 } : {}) }}>
                ...
                <header id="topbar">
                    ...
                    <BotonExportar formato="pdf" campana={campana} className="tb-export-btn">
                        ⬇ PDF oficial
                    </BotonExportar>
                    <BotonExportar formato="excel" campana={campana} className="tb-export-btn">
                        ⬇ Exportar Excel
                    </BotonExportar>
                    {/* User badge */}
                    <div style={{
