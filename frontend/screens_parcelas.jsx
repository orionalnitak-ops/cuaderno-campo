...
// `cod_siex` es el cruce con el catálogo de cultivo SIEX (`Cultivo.xlsx`,
// espacio de códigos totalmente distinto), hecho a mano por nombre — ver
// spec/features/018-siex-cultivo. Duplicado en `backend/helpers.py`
// (CULTIVOS_COD_SIEX): si se añade un cultivo aquí, hay que añadirlo allí
// también con el mismo cod_siex. `null` cuando no hay match razonable.
const CULTIVOS_IACS = [
    { cod: '980',  nombre: 'Barbecho',                 grupo: 'Barbecho',    cod_siex: null },
    { cod: '470',  nombre: 'Arroz',                    grupo: 'Cereales',    cod_siex: '80' },
    { cod: '440',  nombre: 'Avena',                    grupo: 'Cereales',    cod_siex: '8' },
    { cod: '430',  nombre: 'Cebada',                   grupo: 'Cereales',    cod_siex: '5' },
    { cod: '450',  nombre: 'Centeno',                  grupo: 'Cereales',    cod_siex: '6' },
    { cod: '454',  nombre: 'Maíz',                     grupo: 'Cereales',    cod_siex: '4' },
    { cod: '460',  nombre: 'Sorgo',                    grupo: 'Cereales',    cod_siex: '7' },
    { cod: '410',  nombre: 'Trigo blando',             grupo: 'Cereales',    cod_siex: '1' },
    { cod: '415',  nombre: 'Trigo duro',               grupo: 'Cereales',    cod_siex: '3' },
    { cod: '451',  nombre: 'Triticale',                grupo: 'Cereales',    cod_siex: '13' },
    { cod: '550',  nombre: 'Alfalfa',                  grupo: 'Forrajeras',  cod_siex: '60' },
    { cod: '560',  nombre: 'Esparceta / Zulla',        grupo: 'Forrajeras',  cod_siex: '67' },
    { cod: '100',  nombre: 'Ajo',                      grupo: 'Hortalizas',  cod_siex: '169' },
    { cod: '110',  nombre: 'Cebolla',                  grupo: 'Hortalizas',  cod_siex: '157' },
    { cod: '160',  nombre: 'Melón',                    grupo: 'Hortalizas',  cod_siex: '153' },
    { cod: '120',  nombre: 'Patata',                   grupo: 'Hortalizas',  cod_siex: '99' },
    { cod: '162',  nombre: 'Sandía',                   grupo: 'Hortalizas',  cod_siex: '156' },
    { cod: '140',  nombre: 'Tomate',                   grupo: 'Hortalizas',  cod_siex: '197' },
    { cod: '720',  nombre: 'Colza / Nabina',           grupo: 'Industriales', cod_siex: '35' },
    { cod: '701',  nombre: 'Girasol',                  grupo: 'Industriales', cod_siex: '33' },
    { cod: '780',  nombre: 'Remolacha azucarera',      grupo: 'Industriales', cod_siex: '590' },
    { cod: '481',  nombre: 'Guisante proteaginoso',    grupo: 'Leguminosas', cod_siex: '40' },
    { cod: '490',  nombre: 'Haba',                     grupo: 'Leguminosas', cod_siex: '41' },
    { cod: '495',  nombre: 'Soja',                     grupo: 'Leguminosas', cod_siex: '34' },
    { cod: '484',  nombre: 'Veza / Yeros',             grupo: 'Leguminosas', cod_siex: '52' },
    { cod: '1710', nombre: 'Almendro',                 grupo: 'Leñosos',     cod_siex: '104' },
    { cod: '1770', nombre: 'Cerezo / Guindo',          grupo: 'Leñosos',     cod_siex: '110' },
    { cod: '1730', nombre: 'Ciruelo',                  grupo: 'Leñosos',     cod_siex: '111' },
    { cod: '1750', nombre: 'Higuera',                  grupo: 'Leñosos',     cod_siex: '218' },
    { cod: '1840', nombre: 'Limonero',                 grupo: 'Leñosos',     cod_siex: '207' },
    { cod: '1720', nombre: 'Melocotonero / Nectarino', grupo: 'Leñosos',     cod_siex: '105' },
    { cod: '1830', nombre: 'Naranjo',                  grupo: 'Leñosos',     cod_siex: '206' },
    { cod: '1760', nombre: 'Nogal',                    grupo: 'Leñosos',     cod_siex: '112' },
    { cod: '1820', nombre: 'Olivar',                   grupo: 'Leñosos',     cod_siex: '101' },
    { cod: '1740', nombre: 'Pistachero',                grupo: 'Leñosos',    cod_siex: '124' },
    { cod: '1712', nombre: 'Viñedo uva de mesa',       grupo: 'Leñosos',     cod_siex: '103' },
    { cod: '1711', nombre: 'Viñedo vinificación',      grupo: 'Leñosos',     cod_siex: '102' },
];
